...
# OUTPUT char *NFT[][symbols + 1], char TB[]) {
 int len = strlen(S);
 int i, j, k, g;
 int arr[st];
 int sz;
...
```
# OUTPUT:
![image](https://github.com/aryabaisakhiya/Ex-1-NFA-to-DFA/assets/119393645/4f21fb06-530b-4bf6-8cb0-4e587f5ab0f7)
![image](https://github.com/aryabaisakhiya/Ex-1-NFA-to-DFA/assets/119393645/a58f949e-1dfc-4786-a0b6-0b8978e0caf6)
